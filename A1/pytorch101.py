...
def multiples_of_ten(start: int, stop: int) -> Tensor:
    ...
    x = x[x% 10 == 0] # filters out elements that are multiples of 10
    ##########################################################################
    #                            END OF YOUR CODE                            #
    ##########################################################################
    return x
...
def slice_assignment_practice(x: Tensor) -> Tensor:
    ...
    ##########################################################################
    # Replace "pass" statement with your code
    x[0:4,0:6] = torch.tensor([[0,1,2,2,2,2],[0,1,2,2,2,2],[3,4,3,4,5,5],[3,4,3,4,5,5]])
...
def reverse_rows(x: Tensor) -> Tensor:
    ...
    ##########################################################################
    # Replace "pass" statement with your code
    index = torch.arange(x.shape[0]-1,-1,-1) # cannot use flip and torch tensor doesnot have flip
    y = x[index]
    # Pro level Code
    #y = x[range(x.shape[0])[::-1]] # list comprehension
    ##########################################################################
    #                            END OF YOUR CODE                            #
    ##########################################################################
    return y
